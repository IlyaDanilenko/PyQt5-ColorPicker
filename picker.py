from PyQt5.QtWidgets import QWidget, QHBoxLayout, QVBoxLayout, QPushButton, QSlider, QLabel, QApplication
...
class colorpicker_sliders(QWidget):
    def __init__(self, slidersWidgetWidth, spaceBetweenColorpickerAndSliders, spaceBetweenSliders, parent=None):
        ...
        self.brightnessSlider = QSlider(1)
        ...
        self.saturationSlider = QSlider(1)
...
class colorpickerWheel(QWidget):
    def __init__(self, colorpickerSize, startupcolor, mouseDot_size, mouseDotDistance_changer, centralColorWidget_size,
        ...
        self.colorPickerHueWheelImage_File = 'image/colorpicker_wheel.png'
    ...
    def currentColorChanged(self):
        self.parent().onCurrentColorChanged([self.HSV_color, self.rgb_color, self.hsv_color_array_360_base])
...
class ColorPicker(QWidget):
    ...
    def __init__(self, width, startupcolor, parent=None):
        ...
        self.styleSheet_File = 'style/colorPickerStylesheet.css'
        self.setStyleSheet(open(os.path.join(working_directory, self.styleSheet_File)).read())

        self.hsv_color_array = 0
        self.rgb_color_array = 0
        self.hsv_color_array_base_360 = 0
        self.hex_color = 0
        ...
        self.colorpickerWidget = colorpickerWheel(colorpickerSize=self.width, startupcolor=self.startup_color,
                                                  ...
                                                  sliders=self.sliders, parent=self)
    ...
    def onCurrentColorChanged(self, color):
        self.hsv_color_array = color[0]  # (H(0-255), S(0-255), V(0-255))
        self.rgb_color_array = color[1]  # (R(0-255), G(0-255), B(0-255))
